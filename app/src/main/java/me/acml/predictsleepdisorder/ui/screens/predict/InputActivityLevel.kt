...
@Composable
fun InputActivityLevel(
    activityLevel: Float,
    onActivityLevelChange: (Float) -> Unit = {},
    dailySteps: Float,
    onDailyStepsChange: (Float) -> Unit = {},
    onNext: () -> Unit = {}
) {
    Column(
        ...
        Text(
            stringResource(R.string.how_activity_level),
        ...
        HorizontalWheel(
            ...
            ranges = (30..90 step 10).map { it.toFloat() }.toList()
        )
        Text(
        ...
        Text(
            stringResource(R.string.how_many_steps),
            textAlign = TextAlign.Center,
            modifier = Modifier
                .padding(bottom = 30.dp)
                .fillMaxWidth(),
        ...
        HorizontalWheel(
            ...
            ranges = (3000..10000 step 300).map { it.toFloat() }.toList()
        )
        Text(
